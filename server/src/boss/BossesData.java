...
public class BossesData {
    ...
    public static final BossData SHARK = new BossData(
             "Shark",
            ConstPlayer.TRAI_DAT,
    ...
    public static final BossData CHILLED = new BossData(
        ...
        public static final BossData NAMEKSUMMER = new BossData(
            "Namek Hè ", // name
            ConstPlayer.XAYDA, // gender
            new short[] { 1071, 1072, 1073, -1, -1, -1 }, // outfit {head, body, leg, bag, aura, eff}
            50000, // dame
            new int[] {300_000_000}, // hp
            new int[] { 165 }, // map join
            (int[][]) Util.addArray(FULL_ANTOMIC, FULL_KAMEJOKO, FULL_MASENKO, FULL_GALICK), // skill
            new String[] {
            "|-1|Oi Oi Oi, mát tê mát tê"
            }, // text chat 1
            new String[] {
            "|-1|HÈ MÁT QUÁ!",
            "|-1|Ngắm các em chân dài ở bãi biển thật thích thú làm sao!",
            "|-1|Oi bức quá, làm tí kem không cu!",
            "|-1|Thèm dừa, thèm kem quá",
            "|-1|Đm mất điện giữa trưa à",
            "|-1|Sự lạnh lẽo này.. là trái tim crush sao?",
            "|-1|Bật điều hòa lên đi!",
            "|-1|Tia gái ở bãi biển.. chỉ là trò tiêu khiển với ta!",
            "|-1|Một dê cụ chưa từng tia gái thất bại!",
            "|-1|Em mặc bikini màu trắng kia ngon quá!"
            }, // text chat 2
            new String[] {
            "|-1|Hè còn phải đi học hè á???",
            "|-1|Đời bạc đến thế là cùng, đợi đó"
            }, // text chat 3
            REST_15_M // second rest
        );
    }

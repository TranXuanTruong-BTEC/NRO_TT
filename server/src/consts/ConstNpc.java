...
public class ConstNpc {
    ...
    public static final String HUONG_DAN_EVENT = "Mặc quần đùi đi biển, đánh quái sẽ rơi ra các vật phẩm sự kiện\n"
            + "Bao gồm:\n Trái dừa\n Vỏ ốc\n Vỏ sò\n Con cua\n Sao biển\n"
            + "Đủ 10 món mỗi loại sẽ có thể đổi điểm\n"
            + "Ngoài ra mỗi 1 khoản nạp 10.000VNĐ bất kì sẽ tăng 1 điểm\n"
            + "Điểm sẽ được cộng vào đua top, và có thể đổi các hộp quà\n"
            + "2 điểm sẽ đổi được hộp quà thường, 10 điểm sẽ đổi được hộp quà vip\n"
            + "Hộp quà thường mở ra sẽ nhận được Item Cấp 2, phụ kiện,pet, có tỉ lệ vĩnh viễn \n"
            + "Hộp quà vip sẽ mở ra cải trang Himmel, Frieren, Đặc biệt là trang bị kích hoạt vip\n"
            + "Ngoài ra trong thời gian sự kiện, sẽ xuất hiện boss Shark ở các map ngẫu nhiên\n"
            + "Đánh bại boss sẽ rơi ra pet Baby Shark chỉ số ngẫu nhiên 10-15%, với tỉ lệ vĩnh viễn\n"
            + "Ngoài ra cập nhật boss Namek Hè tại map Bãi Biển Kame\n"
            + "Đánh bại boss Namek Hè sẽ rơi ra ngẫu nhiên 1 cải trang Hè trong 3 hành tinh,với chỉ số từ 10-25%\n"
            + "Phần thưởng dành cho Top Sự Kiện:\n"
            + "Top 1: 1 Danh hiệu độc quyền\n" +
"Top 2: 1 phụ kiện đeo lưng độc quyền\n" +
"Top 3: 1 ván bay độc quyền\n"
            + "Phần thưởng dành cho Top Nạp trong thời gian sự kiện:\n"
            + "Top 1: 1 hào quang độc quyền+70 thỏi vang\n" +
"Top 2: 1 cải trang độc quyền+40 thỏi vàng\n" +
"Top 3: 1 cải trang độc quyền+30 thỏi vàng"
            ;
...
//    public static final byte EVENT = 75;
    ...
    public static final byte CHICHI = 75;
 ...
 public static final int event3_1 = 3334;
    ...
    public static final int SHOP_EVENT = 512;

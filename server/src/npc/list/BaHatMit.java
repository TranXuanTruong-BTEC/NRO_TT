            ...
            switch (this.mapId) {
                ...
                default -> {
                    ...
                    if (InventoryService.gI().findItem(player, 454) || InventoryService.gI().findItem(player, 921)) {
                        menu = new ArrayList<>(Arrays.asList("Sách\nTuyệt Kỹ", "Cửa hàng\nBùa", "Nâng cấp\nVật phẩm",  "Mở chỉ số\nBông tai\nPorata cấp\n2" , "Nhập\nNgọc Rồng" , "Nâng cấp bông tai cấp 3" , "Nâng chỉ\nsố bông tai\ncấp 3" ));
                    }
                            ...
                            switch (select) {
                                case 0 -> {
                                    if (InventoryService.gI().getCountEmptyBag(player) > 0) {
                                        Item item = ItemService.gI().createNewItem((short) (Util.nextInt(457, 457)));
                                        item.itemOptions.add(new Item.ItemOption(100, 1));
                    ...
                    if (player.idMark.isBaseMenu()) {
                        ...
                        switch (select) {
                            ...
                            case 5:
                                ...
                                break;
                            case 6:
                                CombineService.gI().openTabCombine(player, CombineService.NANG_CAP_BONG_TAI_CAP_2);
                                break;
                            case 7:
...
//                                    break;
                        ...
                        switch (player.combineNew.typeCombine) {
                            case CombineService.NANG_CAP_BONG_TAI, 
                                    ...
                                    CombineService.NANG_CAP_BONG_TAI_CAP_2,

...
//    public static int EVENT_SEVER = 1;
//    public static byte KHUYEN_MAI_NAP = 1;

    public static boolean LOCAL = false;
    public static boolean TEST = false;
    public static boolean DAO_AUTO_UPDATER = false;
    public static String TIME_VIP_START = "6/07/2025";
    public static String TIME_VIP_END = "6/08/2026";
    ...
    public void loadProperties() throws IOException {
        ...
        if ((value = properties.get("server.name")) != null) {
            ...
            ServerManager.NAME = name.equals("TXG") ? "TXG" : name;
        }

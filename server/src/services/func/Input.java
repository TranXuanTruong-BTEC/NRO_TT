...
public class Input {
    ...
    public static final int DOI_DIEM_EVENT = 515;
    public static final int XIU_taixiu = 516;
    public static final int TAI_taixiu = 517;
  ...
  public void createFormTradeGold(Player pl) {
    ...
    public void createFormDoiDiemSuKiuen(Player pl){
        createForm(pl,DOI_DIEM_EVENT,"Bạn muốn đổi bao nhiêu điểm?", new SubInput("Số lượng", NUMERIC));
    }

...
public class CombineService {
    ...
    public static final int NANG_CAP_BONG_TAI_CAP_2 = 521;
    public static final int NANG_CHI_SO_BONG_TAI_CAP_3 = 522;
    ...
    // <-- THÊM HÀM NÀY -->
    public void sendDataCombine(Player player) {
    try {
        Message msg = new Message(-81);
        msg.writer().writeByte(1); // REOPEN_TAB_COMBINE

...
public class ItemService {
    ...
    // Găng phụ và găng thần đặc biệt: tự thêm option nếu không có trong shop
    if (id >= 555 && id <= 567) {
        list.add(new Item.ItemOption(50, Util.nextInt(2, 5)));    // % Sức đánh
        list.add(new Item.ItemOption(108, Util.nextInt(1, 3)));   // % Né đòn
        list.add(new Item.ItemOption(77, Util.nextInt(100, 200))); // +HP
        return list;
    }

    // Nếu không thuộc 555-567 thì lấy từ shop
